...
export function Footer() {
  return <footer className="site-footer"><div className="wrap footer-inner"><div><Link href="/" className="footer-name">Umair Malik</Link><p>DevOps & Infrastructure Engineer</p></div><div className="footer-links"><a href="https://www.linkedin.com/in/umair-ops/" target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={14} /></a><a href="https://github.com/umairmalik904" target="_blank" rel="noreferrer">GitHub <ArrowUpRight size={14} /></a><EmailLink iconSize={14} /></div><div className="footer-meta"><span>© {new Date().getFullYear()} Umair Malik</span><Link href="/admin">Admin</Link></div></div></footer>;
}
