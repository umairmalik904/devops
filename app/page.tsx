...
export default async function Home() {
  ...
  return <>
    ...
    <main id="main">
      ...
      <section className="wrap contact-strip" id="contact"><span className="section-index">04 / CONTACT</span><div><h2>Let’s talk infrastructure.</h2><a className="contact-email" href="mailto:umair@umairops.com">umair@umairops.com <ArrowUpRight size={26} /></a><p>Cloud infrastructure, deployment automation or a production system that needs attention.</p></div><Link className="button" href="/contact">Start a conversation <ArrowRight size={17} /></Link></section>
    </main><Footer />
  </>;
}
