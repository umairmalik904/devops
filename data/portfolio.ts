...
export const projects = [
  { name: "Private Client Project", private: true, description: "A confidential application engagement. Add a client-approved summary here when it can be shared.", role: "Add your specific infrastructure contribution.", technologies: ["Add stack"] },
  { name: "Private Client Project", private: true, description: "A confidential deployment or infrastructure engagement. Keep sensitive details out while describing the technical scope.", role: "Add your specific infrastructure contribution.", technologies: ["Add stack"] },
  { name: "Project placeholder", private: false, description: "Add a public project when its name, description, contribution, and verified links are available.", role: "Add your specific contribution.", technologies: ["Add stack"] }
];
